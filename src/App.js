                ...
                <div class="relative">
                    <div class="bg-gray-100">
                        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                            <div className="relative lg:pt-16 pb-14 overflow-hidden">
        ...
        clip-rule="evenodd"/>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <p class="mt-2 text-base text-purple-200">
                                            ...
                                            who receive mobile exposure notifications to COVID19. A rapid project spun
                                            up in the early days of the pandemic. Tested, validated, and released in
                                            under a month to help those exposed to COVID19 and provide an additional
                                            layer of tracing data to the scientists fighting it.
                                        </p>
                                    </div>
                                </div>
  ...
  <path
      d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <p class="mt-2 text-base text-purple-200">
                                            A bespoke tango registration, one of the initial projects Speakeasy Tango
                                            LLC. was founded for, designed to allow organizers an easy way to automate
                                            role balancing for dance event and provide a smoother experience for them
                                            and their event
                                            attendees.
                                        </p>
                                    </div>
...
<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd"
        ...
        clip-rule="evenodd"/>
                                    ...
                                    <div class="mt-6">
                                        <h3 class="text-lg font-medium text-white"><a className="underline"
                                                                                      target="_blank">DC Sex Offender
                                            Search</a></h3>
                                        <p class="mt-2 text-base text-purple-200">
                                            Search application for DC sex offender data. First application publicly
                                            released that was built on the <span
                                            className="italic">DC Search App Platform</span> that I designed and
                                            architected to allow for fast and effective application deployment for
                                            spatial data visualization and search. A combination of my team and I's GIS
                                            backgrounds and modern web app solutions needed across DC Government
                                            agencies
                                        </p>
                                    </div>
                                </div>
